module.exports = {
    mulai: `Halo! Saya adalah asisten bot yang akan membantu Anda mendaftar ke kelas trading. 📊💰
...
📝 Registrasi`,
    info: `Selamat datang di Kelas Trading Hexel! 🚀
...
Kami percaya bahwa dengan ilmu yang tepat, siapa pun bisa sukses dalam dunia trading. Ayo bergabung dan mulai perjalanan trading Anda sekarang! 📈✨`,
    help: `🆘 Bantuan - Kelas Trading Hexel

Halo! Berikut adalah daftar perintah yang bisa Anda gunakan di bot ini:

🔹 /start – Memulai bot dan melihat menu utama
🔹 /help – Menampilkan daftar perintah dan bantuan
🔹 /harga – Melihat harga paket kelas trading
🔹 /informasi – Mengetahui lebih lanjut tentang kelas trading ini
🔹 /faq – Melihat pertanyaan yang sering diajukan
🔹 /registrasi – Mendaftar ke kelas trading

📢 Jika Anda mengalami kendala atau membutuhkan bantuan lebih lanjut, silakan hubungi tim support kami melalui tombol ℹ️ Informasi atau kirim pesan langsung ke admin.

🚀 Siap untuk belajar trading? Pilih menu yang sesuai dan mulai perjalanan Anda sekarang!`,

    harga: `💰 Harga Paket Kelas Trading
...
🔹 1. Apa itu Kelas Trading Hexel?
Kelas Trading Hexel adalah program pembelajaran trading yang dirancang untuk membantu pemula hingga trader berpengalaman memahami strategi trading yang efektif dan menguntungkan.

🔹 2. Bagaimana cara mendaftar?
Anda bisa mendaftar dengan mengklik tombol   Registrasi dan mengikuti instruksi yang diberikan oleh bot.

🔹 3. Apa perbedaan paket Basic, Bronze, dan Premium?
✔ Basic – Materi dasar trading & 1 sesi bimbingan online
✔ Bronze – Materi lebih mendalam, 3 sesi bimbingan, dan rekaman kelas
✔ Premium – Materi lanjutan, 5 sesi bimbingan + 1 sesi private, grup VIP, dan sinyal trading

🔹 4. Apakah ada akses ke materi setelah kelas selesai?
Ya! Untuk paket Bronze dan Premium, Anda akan mendapatkan akses ke rekaman kelas agar bisa belajar kapan saja.

🔹 5. Apakah ada sertifikat setelah menyelesaikan kelas?
Saat ini, kami belum menyediakan sertifikat, tetapi kami fokus memberikan ilmu yang benar-benar bisa Anda praktikkan di dunia trading.

🔹 6. Bagaimana jika saya ingin bertanya atau butuh bantuan?
